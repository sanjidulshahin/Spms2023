...
<div class="background">
    ...
    <div class="row3" style="margin-top:5px;"> 
       <div id="Spring" style="width: 300px; height: 400px;margin-left:300px; display:inline-block;margin-top:15px;"></div>
       <div id="Summer" style="width: 300px; height: 400px; display:inline-block;"></div>
       <div id="Autumn" style="width: 300px; height: 400px; display:inline-block;"></div>
    </div>
