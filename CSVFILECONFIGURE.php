 ...
 if (isset($_POST["import"])){
    if ($_FILES['file']['name'])
    {
        ...
        if ($filename[1] == 'csv')
        {
            ...
            {
                $student_id =(int) mysqli_real_escape_string($con,$data[0]);
                $educational_year=(int)mysqli_real_escape_string($con,$data[1]);
                $educational_semester=mysqli_real_escape_string($con,$data[2]);
                $enrolled_course=mysqli_real_escape_string($con,$data[3]);
                $enrolled_section=mysqli_real_escape_string($con,$data[4]);
                $marks = (int)mysqli_real_escape_string($con,$data[5]);
